...
def inference():
	original_data, final_data = evaluate()
	...
	for original_string, final_string in zip(original_string_list, final_string_list):
		final_json_list.append({"adversarialString":final_string,"originalString":original_string})
...
def permissions():
	...
	return json.dumps({'permissions':permissions}), 200, {'ContentType':'application/json'} 
